...
<div class="container pb-6 pr-6 pl-6">
	...
	?>
		...
		<h2 class="title has-text-centered"><?php echo $datos['producto_nombre'] . " (Stock: " . $datos['producto_stock_total'] . " )"; ?></h2>
			...
			<div class="columns">
				...
				<div class="column">
					<div class="control">
						...
						<input class="input" type="text" name="producto_precio_vender" value="<?php echo $datos['producto_precio_vender']; ?>" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" required>
					</div>
				</div>
				<div class="column">
					<div class="control">
			...
			<div class="columns">
				...
				<div class="column">
					<div class="control">
						...
						<input class="input" type="date" name="producto_fecha_ingresado" value="<?php echo $datos['producto_fecha_ingresado']; ?>" required>
					</div>
				</div>
