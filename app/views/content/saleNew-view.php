                    ...
                    <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                        <thead>
                            <tr>
                                ...
                                <th class="has-text-centered">Costo Envio</th>
                                    ...
                                    <tr class="has-text-centered">
                                        ...
                                        <td>
                                            <button type="button" class="button is-success is-rounded is-small"
                                                onclick="actualizar_cantidad_y_envio('#sale_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>','#envio_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>','<?php echo $productos['producto_codigo']; ?>')">
