<section class="full-width navLateral scroll" id="navLateral">
	<div class="full-width navLateral-body">
		...
		<figure class="full-width" style="height: 77px;">
			...
			<figcaption class="navLateral-body-cr mt-3">
				<span>
		...
		<nav class="full-width">
			<ul class="full-width list-unstyle menu-principal">
				...
				<li class="full-width">
					...
					<ul class="full-width menu-principal sub-menu-options">
						<li class="full-width">
							<a href="<?php echo APP_URL; ?>gananciasList/" class="full-width">
								<div class="navLateral-body-cl">
						...
						<li class="full-width">
							<a href="<?php echo APP_URL; ?>inversionesList/" class="full-width">
								<div class="navLateral-body-cl">
						...
						<li class="full-width">
							<a href="<?php echo APP_URL; ?>capitalList/" class="full-width">
								<div class="navLateral-body-cl">
