<?php
	...
	if($datos_venta->rowCount()==1){
        ...
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","*** Precios de productos no incluyen IVA. Para poder realizar un reclamo o devolución debe de presentar este ticket ***"),0,'C',false);
