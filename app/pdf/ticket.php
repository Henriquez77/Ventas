...
if ($datos_venta->rowCount() == 1) {
    ...
    $pdf->Cell(32, 5, MONEDA_SIMBOLO . number_format($subtotal, MONEDA_DECIMALES, MONEDA_SEPARADOR_DECIMAL, MONEDA_SEPARADOR_MILLAR), 0, 0, 'C');

    $pdf->Ln(5);

    /* IVA */
    $pdf->Cell(18, 5, "", 0, 0, 'C');
    $pdf->Cell(22, 5, "IVA (13%)", 0, 0, 'C');
    $pdf->Cell(32, 5, MONEDA_SIMBOLO . number_format($iva, MONEDA_DECIMALES, MONEDA_SEPARADOR_DECIMAL, MONEDA_SEPARADOR_MILLAR), 0, 0, 'C');
    ...
    $pdf->Cell(32, 5, MONEDA_SIMBOLO . number_format($total, MONEDA_DECIMALES, MONEDA_SEPARADOR_DECIMAL, MONEDA_SEPARADOR_MILLAR) . ' ' . MONEDA_NOMBRE, 0, 0, 'C');
    ...
    $pdf->MultiCell(0, 6, iconv("UTF-8", "ISO-8859-1", "*** No se aceptan devoluciones ***"), 0, 'C', false);
